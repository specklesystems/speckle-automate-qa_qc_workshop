...
class FunctionInputs(AutomateBase):
    ...
    # Original input from exercise 0
    comment_phrase: str = Field(
        title="Comment Phrase",
        description="This phrase will be added to a random model element.",
    )
    
    # NEW in Exercise 1: Added field to specify how many elements to process
    # This allows users to control the scope of the automation
